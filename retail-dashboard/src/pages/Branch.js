...
function Branch() {
  ...
  const handleAuthSubmit = () => {
    // Check if branch code matches (simple demo validation)
    if (branchCode === `branch${branchId}`) {
      ...
      alert("Invalid branch code. Try: branch" + branchId);
    }
  };
  ...
  return (
    <>
      <div className="page-header">
        <h1>Branch {branchId} - Dashboard</h1>
      ...
      {showAuthModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p>Please enter your branch code to verify upload permission:</p>
            <input
              type="password"
